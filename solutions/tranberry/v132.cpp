// Tranberry v132: transactional topology-unlocking endgame.
// Follow QEM with valence-weld and pair-disk retriangulation before original-render selection.
...
void continueAbsoluteQem(double ratio){
    ...
    if(elapsed()<HParam_TimeBudgetSeconds-0.88)pairDiskPass();
    compact();
}
