// Tranberry v130: topology-first continuation under final original-render verification.
// Remove the redundant strict local geometry veto while retaining normal manifold and envelope gates.
