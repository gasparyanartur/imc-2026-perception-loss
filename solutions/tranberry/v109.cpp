// Tranberry v109: v105 + render-ranked placement selection on tier 2 with geometry caps.
...
c.position=p;c.cost=qg.evaluate(p);c.rankCost=screenTier==2?qr.evaluate(p):c.cost;return c;
