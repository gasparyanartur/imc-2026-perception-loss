...
if(nV>5000&&nV<=50000){
if(nV>25000&&nV<=45000){runScreenCoreMid();exactPlanarStarPass(true);vegaSsimEdgePass(true);compact();}
...
if(inputV<=400000)exactPlanarStarPass(true);
...
if(tier==2){
runScreenCoreMid();exactPlanarStarPass(true);vegaSsimEdgePass(true);
