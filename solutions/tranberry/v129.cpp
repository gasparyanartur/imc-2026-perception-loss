// Tranberry v129: remove the QEM cost ceiling inside original-render-guarded continuation.
// The proven mesh remains the fallback; expensive collapses may expose a lower-count basin.
