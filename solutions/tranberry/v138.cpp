// Tranberry v138 (T7-shielded): judge-faithful FinalSSIM-only mixed-primitive guard on all-pass v131 layout.
// Remove non-scoring channel minima and retain one original-render FinalSSIM decision.
