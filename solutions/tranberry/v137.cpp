// Tranberry v137: judge-faithful FinalSSIM-only transaction guard on all-pass v130 layout.
// Remove per-view and per-channel vetoes absent from the official scoring rule.
