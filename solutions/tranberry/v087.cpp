// Tranberry v087: v072 + signed-volume-preserving edge placement on medium meshes.
// The local one-ring volume equation becomes an additional QEM plane, so collapse
// placement explicitly resists shrinkage instead of relying only on tangent planes.
...
v.scale(0.25*max(1e-12,q.a+q.e+q.h));q+=v;return q;
}
