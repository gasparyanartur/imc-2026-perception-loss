// Tranberry v135: judge-aligned absolute transaction guard on the all-pass v130 layout.
// Preserve the runtime branch while accepting meshes with substantial margin above 0.9.
