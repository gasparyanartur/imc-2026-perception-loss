// Tranberry v115: v105 + parameter-free minimax render-geometry placement on tier 2.
...
Vec3 pos[6];int np;getCandidatePositions(a,b,q,pos,np);if(screenTier==2){Vec3 rp,gp;if(solveQem3x3(q,rp)&&solveQem3x3(qc,gp)&&np<6)pos[np++]=minimaxBridge(q,qc,rp,gp);}
