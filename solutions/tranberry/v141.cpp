// Tranberry v141: T7-shielded render-once mixed-primitive transaction.
// Eliminate candidate re-render and spend the saved time on QEM-plus-star simplification.
