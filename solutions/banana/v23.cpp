...
static const TierParams tierTable[NUM_TIERS] = {
    // T1: 0 <= nV < 5000 (tiny meshes; v67 - keepRatio 0.00, memless=false)
    {
        ...
        .vegaMaxValence = 5, .vegaMaxOldDev = 0.018, .vegaMaxNewDev = 0.030,
        .vegaDistFrac = 0.76, .vegaExtraFrac = 0.0100,
        .vegaHardCap = 350, .vegaScanVertices = 40000, .vegaRounds = 1,
        .vegaPatchGeomFrac = 0.70,
        .vegaSsimMin = 0.940, .vegaDamageMax = 0.030,
