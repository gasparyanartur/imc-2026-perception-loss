...
static const TierParams tierTable[NUM_TIERS] = {
    // T1: 0 <= nV < 5000 (tiny meshes; v67 - keepRatio 0.00, memless=false)
    {
        ...
        .vegaMaxValence = 5, .vegaMaxOldDev = 0.015, .vegaMaxNewDev = 0.025,
        .vegaDistFrac = 0.70, .vegaExtraFrac = 0.0140,
        .vegaHardCap = 500, .vegaScanVertices = 60000, .vegaRounds = 1,
        .vegaPatchGeomFrac = 0.80,
        .vegaSsimMin = 0.950, .vegaDamageMax = 0.025,
