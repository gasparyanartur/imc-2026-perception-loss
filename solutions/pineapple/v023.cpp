// Pineapple v023: Composite - higher face weight caps + anchor boost.
// Combines v020 (T2 24, T4 22 caps) and v011 (anchor 1.4x/1.2x boost).
// Hypothesis: stronger face-weight separation AND stronger visible-vertex
// anchors together give a stronger perceptual signal that biases collapse
// order toward unimportant faces. Combined directional change.
#include <bits/stdc++.h>
