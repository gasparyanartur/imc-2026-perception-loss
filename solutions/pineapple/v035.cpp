// Pineapple v035: Non-screen-core-only changes (T1/T5/T6).
// Hypothesis: Screen core has zero slack (T2/T3/T4 break at any reduction).
// Try mild reductions on T1/T5/T6 only. If T5 or T6 has slack, this gains
// score without breaking screen-core cases 3/4/5.
// T1 floor +0.005, T5 0.025 -> 0.024, T6 0.032 -> 0.031.
#include <bits/stdc++.h>

static constexpr double HParam_Pineapple_KeepRatio_UpTo5k = 0.005;
static constexpr double HParam_Pineapple_KeepRatio_UpTo400k = 0.024;
static constexpr double HParam_Pineapple_KeepRatio_Huge = 0.031;
...
static constexpr double HParam_KeepRatio_UpTo5k = HParam_Pineapple_KeepRatio_UpTo5k;
