// Pineapple v087: Composite v082 + v083. Build on v079 with:
// 1. T5 weld maxValence 6→8, scanVertices 760→1500 (v082)
// 2. T6 weld/pair-disk enabled with T6-tuned params (v083)
// Hypothesis: T5 and T6 are independent - both have stranded edges. Combining
// should give additive improvement. Affects T5 (case 6) and T6 (case 7).
#include <bits/stdc++.h>
