// Pineapple v019: T5 + T6 reductions (-0.3pt each).
// Hypothesis: Both giant tiers have slack; combining safe -0.3pt reductions
// on T5 (0.025 -> 0.022) and T6 (0.032 -> 0.029) should improve cases 6-7.
#include <bits/stdc++.h>

static constexpr double HParam_Pineapple_KeepRatio_UpTo400k = 0.022;
static constexpr double HParam_Pineapple_KeepRatio_Huge = 0.029;
