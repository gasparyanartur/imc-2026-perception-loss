// Pineapple v086: Build on v079 (T5 weld/pair-disk) + raise the star-delete
// gate from 400k to 1M. Currently collapseInvisibleEdges skips T6 (≥1M).
// We raise the threshold so T6 (≥1M) also gets star-delete post-pass.
// Hypothesis: giant meshes have many invisible edges; star-delete reduces
// vertex count without visible degradation. Affects T6 (case 7).
#include <bits/stdc++.h>
