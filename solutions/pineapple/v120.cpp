// Pineapple v120: v115 + T5 weld maxOldDev 0.020 → 0.030, T6 weld 0.024 → 0.034.
// More lenient deviation thresholds for giant-tier weld.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {10, 0.030, 0.032, 0.80, 0.0150, 10000, 280000, 1, 0.60, 2.80};
        if (t == 6)
            return {6, 0.034, 0.038, 0.95, 0.0180, 10000, 280000, 1, 0.68, 5.00};
