// Pineapple v137: v130 + T5/T6 pair-disk scanVertices 90 → 1000 + maxSeconds bumped.
// Test if pair-disk budget is the next lever after weld plateau.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams pairDiskParams() const
    {
        ...
        if (t == 5)
            return {8, 0.024, 0.038, 0.78, 0.0035, 1000, 120000, 1, 0.30, 2.00};
        if (t == 6)
            return {8, 0.030, 0.045, 0.95, 0.0045, 1000, 120000, 1, 0.34, 2.50};
