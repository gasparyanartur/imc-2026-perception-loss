// Pineapple v101: v092 + T6 pair-disk scanVertices 90 → 200 + T5 pair-disk scanVertices 90 → 200.
// Hypothesis: giant-tier pair-disk needs more scan budget.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {8, 0.020, 0.032, 0.80, 0.0150, 2500, 280000, 1, 0.60, 2.80};
        if (t == 6)
    ...
    StarParams pairDiskParams() const
    {
        ...
        if (t == 5)
            return {8, 0.024, 0.038, 0.78, 0.0035, 200, 120000, 1, 0.30, 0.95};
        if (t == 6)
            return {8, 0.030, 0.045, 0.95, 0.0045, 200, 120000, 1, 0.34, 1.05};
