// Pineapple v065: v061's tightened keepRatios AND MEMLESS=false on
// screen-core path.
// Hypothesis: combining both safety improvements - the v061 local-best
// tightening with MEMLESS=false to preserve original quadric weights
// during rebuild (which v062 found to be inert alone).
//   Keep ratios: same as v061 (T2 0.35/0.32/0.29, T4 0.13/0.09/0.07)
//   T3 final: 0.135
//   Caps: 25 uniform (same as v061)
//   MEMLESS: false on T2/T3/T4 (was (nV > 5000))
#include <bits/stdc++.h>
...
private:
    ...
    void initScale()
    {
        ...
        MEMLESS = (screenTier == 0 && nV > 5000); // v065: disable MEMLESS on screen-core path
