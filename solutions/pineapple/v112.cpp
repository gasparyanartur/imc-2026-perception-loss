// Pineapple v112: v110 + T5 weld scanVertices 6000 → 8000. Even more T5 scan.
// Hypothesis: v110 best with T5=6000; pushing higher may continue gains.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {10, 0.020, 0.032, 0.80, 0.0150, 8000, 280000, 1, 0.60, 2.80};
        if (t == 6)
            return {6, 0.024, 0.038, 0.95, 0.0180, 4000, 280000, 1, 0.68, 5.00};
