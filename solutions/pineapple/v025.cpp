// Pineapple v025: Anchor quadric carried into MEMLESS rebuilds.
// Hypothesis: Nebula's MEMLESS rebuild (in applyCollapse, screenTier 2/4
// path) recomputes vquad from surviving faces via weightedFaceQuadric, but
// the anchor quadrics added at the end of initFaceWeights are NOT included.
// After MEMLESS rebuild, screen-core visible-vertex protection is silently
// dropped on every collapse. Carry the anchor quadric forward.
#include <bits/stdc++.h>
