// Pineapple v097: v092 + T6 weld scanVertices 760 → 1500 (same bump as T5).
// Hypothesis: T6 weld benefits from same scan boost as T5.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 6)
            return {6, 0.024, 0.038, 0.95, 0.0180, 1500, 280000, 1, 0.68, 3.20};
