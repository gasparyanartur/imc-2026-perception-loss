// Pineapple v028: 5x/4x anchor boost + MEMLESS carry (v027 even stronger).
// Hypothesis: very strong anchors may be needed to actually move the needle.
// Lower keep-ratios in the next stage may become safe with this protection.
#include <bits/stdc++.h>

static constexpr bool HParam_Pineapple_AnchorMemlessCarry = true;
static constexpr double HParam_Pineapple_AnchorBoostT2 = 5.0;
static constexpr double HParam_Pineapple_AnchorBoostT4 = 4.0;
