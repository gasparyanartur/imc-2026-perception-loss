// Pineapple v135: v130 + T5/T6 weld maxSeconds 2.80/5.00 → 5.00/8.00. All knobs.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {15, 0.020, 0.032, 0.80, 0.0150, 15000, 280000, 1, 0.60, 5.00};
        if (t == 6)
            return {10, 0.024, 0.038, 0.95, 0.0180, 15000, 280000, 1, 0.68, 8.00};
