// Pineapple v133: v130 + T5/T6 weld scanVertices 15K → 25K. Mid-point of v130/v132.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {15, 0.020, 0.032, 0.80, 0.0150, 25000, 280000, 1, 0.60, 2.80};
        if (t == 6)
            return {10, 0.024, 0.038, 0.95, 0.0180, 25000, 280000, 1, 0.68, 5.00};
