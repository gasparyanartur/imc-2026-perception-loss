// Pineapple v105: v100 + T5 weld scanVertices 2500 → 4000. Push T5 scan even higher.
// Hypothesis: T5 weld still benefits from more scan budget.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {10, 0.020, 0.032, 0.80, 0.0150, 4000, 280000, 1, 0.60, 2.80};
        if (t == 6)
