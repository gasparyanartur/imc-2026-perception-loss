// Pineapple v082: Build on v079 (T5 weld/pair-disk enable) with more aggressive
// weld params for T5. Doubled maxValence 6→8, doubled maxSeconds via scanVertices
// 760→1500. Hypothesis: v079's +0.018pt local improvement suggests T5 has many
// stranded edges; more aggressive weld finds more candidates. Affects T5.
#include <bits/stdc++.h>
