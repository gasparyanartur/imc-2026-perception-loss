// Pineapple v020: Higher face weight caps (T2 18->24, T4 16->22).
// Hypothesis: face weights that distinguish "important" from "unimportant"
// faces more sharply should bias the collapse order toward unimportant
// edges first. Tangerine tested keep-ratios (rejected) and silhouette
// planes (too positional). This is a softer lever: change the face-weight
// mapping instead of the keep target.
#include <bits/stdc++.h>
