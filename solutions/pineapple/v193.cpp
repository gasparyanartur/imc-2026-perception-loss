// Pineapple v193: v188 + T4 weld maxOldDev 0.050 → 0.100, maxNewDev 0.060 → 0.150.
// Very lenient T4 weld deviation thresholds.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        int t = originalTier();
        if (t == 4)
            return {25, 0.100, 0.150, 0.66, 0.0110, 3500, 280000, 1, 0.52, 2.30};
        if (t == 5)
