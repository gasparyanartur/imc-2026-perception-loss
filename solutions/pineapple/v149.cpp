// Pineapple v149: v141 + T4 pair-disk scanVertices 90 → 200 + maxSeconds 0.85 → 2.00.
// Modest pair-disk bump.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        int t = originalTier();
        if (t == 4)
            return {10, 0.015, 0.024, 0.66, 0.0110, 3000, 280000, 1, 0.52, 2.30};
        if (t == 5)
            return {15, 0.020, 0.032, 0.80, 0.0150, 15000, 280000, 1, 0.60, 2.80};
        if (t == 6)
            return {10, 0.024, 0.038, 0.95, 0.0180, 15000, 280000, 1, 0.68, 5.00};
    ...
    StarParams pairDiskParams() const
    {
        ...
        int t = originalTier();
        if (t == 4)
            return {8, 0.018, 0.029, 0.66, 0.0025, 200, 120000, 1, 0.28, 2.00};
        if (t == 5)
            return {8, 0.024, 0.038, 0.78, 0.0035, 500, 120000, 1, 0.30, 1.50};
        if (t == 6)
            return {8, 0.030, 0.045, 0.95, 0.0045, 500, 120000, 1, 0.34, 1.80};
