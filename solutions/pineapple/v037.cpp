// Pineapple v037: Big T5 reduction only (T6 unchanged).
// Hypothesis: T5 may have more slack than T6. Try -0.5pt (0.025 -> 0.020).
// Test if this is safe while leaving T6 at baseline.
#include <bits/stdc++.h>
