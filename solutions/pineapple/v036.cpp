// Pineapple v036: Bigger T5/T6 reductions (T1 unchanged).
// Hypothesis: T5 and T6 have meaningful slack. Try -0.3pt and -0.4pt.
// T5 0.025 -> 0.022, T6 0.032 -> 0.028. Screen core untouched.
#include <bits/stdc++.h>
