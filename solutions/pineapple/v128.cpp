// Pineapple v128: v125 + T5/T6 weld maxSeconds bumped. Time + scan + maxValence.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {12, 0.020, 0.032, 0.80, 0.0150, 15000, 280000, 1, 0.60, 5.00};
        if (t == 6)
            return {8, 0.024, 0.038, 0.95, 0.0180, 15000, 280000, 1, 0.68, 8.00};
