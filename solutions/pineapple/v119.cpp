// Pineapple v119: v115 + T5/T6 weld rounds 1 → 2. More iterations per pass.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {10, 0.020, 0.032, 0.80, 0.0150, 10000, 280000, 2, 0.60, 2.80};
        if (t == 6)
            return {6, 0.024, 0.038, 0.95, 0.0180, 10000, 280000, 2, 0.68, 5.00};
