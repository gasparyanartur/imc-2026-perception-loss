// Pineapple v107: v105 + T5 weld scanVertices 4000 → 6000. Even more T5 scan.
// Hypothesis: v105 was best at 4000 scanVertices, going to 6000 might continue.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {10, 0.020, 0.032, 0.80, 0.0150, 6000, 280000, 1, 0.60, 2.80};
        if (t == 6)
