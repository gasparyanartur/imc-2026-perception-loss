// Pineapple v039: Mild T5/T6 + T1 cap boost (no screen core).
// Hypothesis: T5/T6 need only a small adjustment. T1 currently has 0
// floor - maybe a slight floor helps preserve tiny mesh geometry.
// T5 0.025 -> 0.024, T6 0.032 -> 0.030, T1 floor 0.0 -> 0.003.
#include <bits/stdc++.h>

static constexpr double HParam_Pineapple_KeepRatio_UpTo5k = 0.003;
