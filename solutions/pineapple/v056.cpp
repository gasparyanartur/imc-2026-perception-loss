// Pineapple v052: T6 keepRatio reduction only (0.032 -> 0.028).
// Hypothesis: T6 (giant tier) may have slack. -0.4pt reduction.
#include <bits/stdc++.h>

static constexpr double HParam_Pineapple_KeepRatio_UpTo400k = 0.025;
static constexpr double HParam_Pineapple_KeepRatio_Huge = 0.026;
