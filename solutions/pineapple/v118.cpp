// Pineapple v118: v115 + T5/T6 weld maxSeconds doubled (5.00/8.00). Time + scan.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {10, 0.020, 0.032, 0.80, 0.0150, 10000, 280000, 1, 0.60, 5.00};
        if (t == 6)
            return {6, 0.024, 0.038, 0.95, 0.0180, 10000, 280000, 1, 0.68, 8.00};
