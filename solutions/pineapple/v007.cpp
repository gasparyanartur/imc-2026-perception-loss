// Pineapple v007: Vega gate with larger budget (v002 redux with 16s budget).
// v002 used 4s budget and never fired on Kattis. Hypothesis: with 16s budget,
// the gate fires often enough to actually prevent perceptually-risky
// collapses on official mid-tier meshes.
#include <bits/stdc++.h>
...
static constexpr double HParam_Pineapple_VegaGateBudgetSeconds = 16.0;
