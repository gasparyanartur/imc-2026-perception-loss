// Pineapple v096: v089 + T6 pair-disk scanVertices 90 → 180 + T6 pair-disk
// maxSeconds 1.05 → 1.80. Hypothesis: more time for T6 pair-disk = more candidates.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams pairDiskParams() const
    {
        ...
        if (t == 6)
            return {8, 0.030, 0.045, 0.95, 0.0045, 180, 120000, 1, 0.34, 1.80};
