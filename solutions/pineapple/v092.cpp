// Pineapple v092: v089 + T5 weld scanVertices 1500 → 2500 (more time per pass).
// Hypothesis: v089 already combines all giant-tier improvements. Adding more
// scan budget to T5 weld might find additional candidates. Affects T5.
#include <bits/stdc++.h>
