// Pineapple v106: v100 + T5/T6 pair-disk scanVertices 90 → 200. Even more
// aggressive pair-disk on giant tiers.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {10, 0.020, 0.032, 0.80, 0.0150, 2500, 280000, 1, 0.60, 2.80};
        if (t == 6)
            return {6, 0.024, 0.038, 0.95, 0.0180, 2500, 280000, 1, 0.68, 5.00};
