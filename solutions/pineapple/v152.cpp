// Pineapple v152: v141 with T4 weld scanVertices 3000 → 2000 (safer for Kattis timeout).
// Hypothesis: v140 (scanVertices 1500) succeeded, v141 (scanVertices 3000) might time out.
// 2000 is in between and should be safer.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        int t = originalTier();
        if (t == 4)
            return {10, 0.015, 0.024, 0.66, 0.0110, 2000, 280000, 1, 0.52, 2.30};
        if (t == 5)
