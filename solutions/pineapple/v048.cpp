// Pineapple v048: Vertex-grid clustering pre-pass for screen-core.
// Hypothesis: Nebula's QEM collapses edges based on quadric cost. What if
// we add a vertex-grid pre-pass that collapses nearby vertices (clustering)
// BEFORE QEM? This reduces vertex count cheaply without topology change.
// Grid cell size = 0.04 * diag (about 1% of mesh).
#include <bits/stdc++.h>

static constexpr bool HParam_Pineapple_VertexGridClustering = true;
static constexpr double HParam_Pineapple_VertexGridSize = 0.04;
