// Pineapple v038: Big T6 reduction only (T5 unchanged).
// Hypothesis: T6 may have more slack than T5. Try -0.7pt (0.032 -> 0.025).
// Test if T6 has more headroom than T5.
#include <bits/stdc++.h>

static constexpr double HParam_Pineapple_KeepRatio_Huge = 0.025;
