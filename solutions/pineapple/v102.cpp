// Pineapple v102: v100 + T6 weld maxValence 6 → 10 (matches T5 bump).
// Hypothesis: T6 weld benefits from same maxValence bump as T5.
// This is the maximum-aggression giant-tier weld configuration.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 6)
            return {10, 0.024, 0.038, 0.95, 0.0180, 2500, 280000, 1, 0.68, 5.00};
