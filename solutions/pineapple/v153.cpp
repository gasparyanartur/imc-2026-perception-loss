// Pineapple v153: v152 with T4 weld scanVertices 2000 → 1500. Even safer (matches v140).
// Hypothesis: ensure no timeout on Kattis. v140 (scanVertices 1500) was confirmed safe.
#include <bits/stdc++.h>
