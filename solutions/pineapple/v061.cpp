// Pineapple v061: aggressive tightening of screen-core keep ratios
// (-0.010) AND very high face weight caps (25.0 uniform).
// Hypothesis: aggressive retention reduction + much stronger importance
// weighting on protected faces tests if we're under-using the visible
// protection budget.
//   T2:  0.36, 0.33, 0.30 -> 0.35, 0.32, 0.29
//   T4:  0.14, 0.10, 0.08 -> 0.13, 0.09, 0.07
//   T3:  0.145 -> 0.135
//   Caps: T2 18->25, T3 7->25, T4 16->25 (uniform high)
#include <bits/stdc++.h>
