// Pineapple v091: Composite v082 + cost cap +20% (v077). T5 weld aggressive +
// widened QEM cost window. Hypothesis: more aggressive cost cap means more
// expensive collapses survive main loop; weld post-pass cleans residual edges.
// v082 alone gave +0.036pt; v077 was inert locally on top of v079 but might
// help here. Affects T5 (case 6) primarily.
#include <bits/stdc++.h>
