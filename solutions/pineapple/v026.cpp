// Pineapple v026: Stronger anchor boost + MEMLESS anchor carry (v011+v025).
// Combines 1.4x/1.2x anchor boost with MEMLESS rebuild carry-forward.
// Hypothesis: stronger anchors added per stage AND preserved across collapses
// should make screen-core SSIM much more robust, allowing tighter keep-ratios
// or more aggressive collapse selection.
#include <bits/stdc++.h>
