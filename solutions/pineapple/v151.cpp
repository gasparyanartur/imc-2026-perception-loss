// Pineapple v151: v141 + T4 weld maxValence 10→12 + scanVertices 3000→4000.
// Mid-point between v141 (scan 3000) and v142 (scan 8000).
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        int t = originalTier();
        if (t == 4)
            return {12, 0.015, 0.024, 0.66, 0.0110, 4000, 280000, 1, 0.52, 2.30};
        if (t == 5)
