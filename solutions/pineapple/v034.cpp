// Pineapple v034: Star-delete heavy + giant tier reductions.
// Combines: (a) T2/T4 stages unchanged (Nebula baseline),
// (b) add star-delete post-pass on screen core T2/T4 (tight params),
// (c) T5 keepRatio 0.025->0.024, (d) T6 keepRatio 0.032->0.030,
// (e) face weight caps T2/T4 +11% (18->20, 16->18).
// Hypothesis: pure giant-tier reductions + post-pass + small cap shift.
// Each lever is mild but they add up.
#include <bits/stdc++.h>

static constexpr double HParam_Pineapple_FaceWeightCapT2 = 20.0;
static constexpr double HParam_Pineapple_FaceWeightCapT4 = 18.0;
