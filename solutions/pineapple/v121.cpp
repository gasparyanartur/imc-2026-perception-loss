// Pineapple v121: v115 + T5/T6 weld maxNewDev bumped. More lenient new deviation.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {10, 0.020, 0.040, 0.80, 0.0150, 10000, 280000, 1, 0.60, 2.80};
        if (t == 6)
            return {6, 0.024, 0.048, 0.95, 0.0180, 10000, 280000, 1, 0.68, 5.00};
