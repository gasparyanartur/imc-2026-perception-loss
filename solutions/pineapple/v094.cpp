// Pineapple v094: v089 + T6 weld maxValence 6→8 (matches T5 aggressiveness).
// Hypothesis: T6 has more vertices; allow higher valence weld to find more candidates.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 6)
            return {8, 0.024, 0.038, 0.95, 0.0180, 760, 280000, 1, 0.68, 3.20};
