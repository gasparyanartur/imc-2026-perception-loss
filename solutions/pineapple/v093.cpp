// Pineapple v093: v089 + T5 weld maxSeconds bumped (2.80 → 4.00) + T5 pair-disk
// scanVertices 90 → 200. Hypothesis: more time/scan budget for T5 passes.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {8, 0.020, 0.032, 0.80, 0.0150, 1500, 280000, 1, 0.60, 4.00};
        if (t == 6)
