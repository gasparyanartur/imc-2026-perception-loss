// Pineapple v095: v089 + T5 weld maxSeconds 2.80 → 5.00 + T6 weld maxSeconds
// 3.20 → 6.00. Hypothesis: more time for giant-tier weld = more candidates.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {8, 0.020, 0.032, 0.80, 0.0150, 1500, 280000, 1, 0.60, 5.00};
        if (t == 6)
            return {6, 0.024, 0.038, 0.95, 0.0180, 760, 280000, 1, 0.68, 6.00};
