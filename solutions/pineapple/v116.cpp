// Pineapple v116: v114 + T5 weld maxSeconds 2.80 → 5.00 + T6 weld maxSeconds 5.00 → 8.00.
// Push maxSeconds too.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {10, 0.020, 0.032, 0.80, 0.0150, 8000, 280000, 1, 0.60, 5.00};
        if (t == 6)
            return {6, 0.024, 0.038, 0.95, 0.0180, 6000, 280000, 1, 0.68, 8.00};
