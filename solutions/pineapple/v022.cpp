// Pineapple v022: Lower face weight floor (T2 0.06->0.03, T4 0.06->0.03).
// Hypothesis: lowering the floor lets unimportant faces contribute even
// less to the quadric, making their vertices easier to collapse. This is
// the opposite direction from v021 and tests which lever matters more.
#include <bits/stdc++.h>
...
static constexpr double HParam_Pineapple_FaceWeightFloorT2 = 0.03;
static constexpr double HParam_Pineapple_FaceWeightFloorT4 = 0.03;
