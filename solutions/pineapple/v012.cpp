// Pineapple v012: Looser Vega-aware cap (v003 redux with pow 0.9).
// v003 used pow 1.4 which was too aggressive on case 7. Hypothesis: a softer
// cap modulation (pow 0.9, max 1.1) protects visible vertices without
// over-tightening the cost budget.
#include <bits/stdc++.h>

static constexpr bool HParam_Pineapple_VegaAwareCap = true;
static constexpr double HParam_Pineapple_VegaAwareCapRiskPow = 0.9;
static constexpr double HParam_Pineapple_VegaAwareCapRiskMax = 1.1;
