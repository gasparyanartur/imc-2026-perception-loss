// Pineapple v124: v117 + T5/T6 weld extraFrac bumped. More extra deletes per pass.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {10, 0.020, 0.032, 0.80, 0.0250, 15000, 280000, 1, 0.60, 2.80};
        if (t == 6)
            return {6, 0.024, 0.038, 0.95, 0.0280, 15000, 280000, 1, 0.68, 5.00};
