// Pineapple v088: Composite v082 + v086. T5 weld maxValence 6→8 + T6 star-delete
// enabled (HParam_TailOriginalVertexThreshold 400k → 1M). Hypothesis: T5 weld
// gives +0.036pt; T6 star-delete gives +0.034pt. Both target different tiers
// so should compound to ~+0.07pt.
#include <bits/stdc++.h>
