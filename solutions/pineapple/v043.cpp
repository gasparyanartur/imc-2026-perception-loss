// Pineapple v043: Stronger importance penalty (v042 redux, weight 0.6).
// Hypothesis: A stronger penalty (0.6 vs 0.3) more aggressively biases
// the queue toward unimportant areas. Should produce a different mesh
// than v042.
#include <bits/stdc++.h>

static constexpr bool HParam_Pineapple_ImportancePenalty = true;
static constexpr double HParam_Pineapple_ImportancePenaltyWeight = 0.60;
static constexpr double HParam_Pineapple_ImportancePenaltyMax = 3.0;
