// Pineapple v100: v092 + v097 + v098 + v099 combined. T5 + T6 weld scanVertices
// 760/1500 → 2500, T5 weld maxValence 8 → 10, T6 weld maxSeconds 3.20 → 5.00.
// The full "very aggressive giant-tier post-pass" configuration.
#include <bits/stdc++.h>
