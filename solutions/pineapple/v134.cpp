// Pineapple v134: v130 + T5/T6 weld scanVertices 15K → 20K + maxValence T5=12 T6=10.
// Test if mid-bump scanVertices with v130 maxValence helps.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {12, 0.020, 0.032, 0.80, 0.0150, 20000, 280000, 1, 0.60, 2.80};
        if (t == 6)
            return {10, 0.024, 0.038, 0.95, 0.0180, 20000, 280000, 1, 0.68, 5.00};
