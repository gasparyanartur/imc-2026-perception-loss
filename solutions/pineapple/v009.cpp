// Pineapple v009: Looser Vega gate (v002 redux with 0.945 floor).
// v002 used 0.965 floor / 0.040 damage. Hypothesis: looser gating allows more
// aggressive collapse, possibly recovering compression on T3/T4 that the
// tighter gate discards.
#include <bits/stdc++.h>

static constexpr bool HParam_Pineapple_VegaGate = true;
static constexpr double HParam_Pineapple_VegaGateMinSsim = 0.945;
static constexpr double HParam_Pineapple_VegaGateMaxDamage = 0.060;
