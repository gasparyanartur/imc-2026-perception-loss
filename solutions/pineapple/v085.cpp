// Pineapple v085: Build on v079 (T5 weld/pair-disk enable) with more aggressive
// pair-disk params for T5 (maxValence 8→12, scanVertices 90→180). Affects T5.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams pairDiskParams() const
    {
        ...
        if (t == 5)
            return {12, 0.024, 0.038, 0.78, 0.0035, 180, 120000, 1, 0.30, 0.95};
