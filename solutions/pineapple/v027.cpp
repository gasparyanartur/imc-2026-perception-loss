// Pineapple v027: 3x/2.5x anchor boost + MEMLESS carry (v026 stronger).
// Hypothesis: 3x/2.5x boost is more aggressive. v011 with 1.4x/1.2x
// was inert, so try stronger. MEMLESS carry should preserve any
// additional protection through the rebuild.
#include <bits/stdc++.h>

static constexpr bool HParam_Pineapple_AnchorMemlessCarry = true;
static constexpr double HParam_Pineapple_AnchorBoostT2 = 3.0;
static constexpr double HParam_Pineapple_AnchorBoostT4 = 2.5;
