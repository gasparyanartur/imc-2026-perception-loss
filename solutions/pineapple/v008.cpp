// Pineapple v008: Tighter Vega gate (v002 redux with 0.985 SSIM floor).
// v002 used 0.965 floor / 0.040 damage. Hypothesis: stricter gating reduces
// false negatives that hurt the T2-T4 SSIM gate.
#include <bits/stdc++.h>

static constexpr bool HParam_Pineapple_VegaGate = true;
static constexpr double HParam_Pineapple_VegaGateMinSsim = 0.985;
static constexpr double HParam_Pineapple_VegaGateMaxDamage = 0.020;
