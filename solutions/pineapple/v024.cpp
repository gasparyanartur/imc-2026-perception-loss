// Pineapple v024: Tighten T3 final target (0.145 -> 0.142).
// Tangerine tested T3 -1pt (0.145 -> 0.135) and failed. Try a smaller
// -0.3pt (0.145 -> 0.142) for case 4 improvement without breaking SSIM.
#include <bits/stdc++.h>
