// Pineapple v016: T6 keepRatio 0.032 -> 0.025 (case 7 direction).
// Hypothesis: T6 (giant tier) is over-conservative. Reducing to T5's
// keepRatio may gain case 7 compression without breaking SSIM.
#include <bits/stdc++.h>
