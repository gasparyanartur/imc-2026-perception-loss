// Pineapple v139: v130 + T5/T6 weld scanVertices → 30K + T5/T6 pair-disk scanVertices → 500.
// Combine all bumps: maxValence + high weld scan + pair-disk.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {15, 0.020, 0.032, 0.80, 0.0150, 30000, 280000, 1, 0.60, 2.80};
        if (t == 6)
            return {10, 0.024, 0.038, 0.95, 0.0180, 30000, 280000, 1, 0.68, 5.00};
