// Pineapple v187: v182 + T4 weld maxOldDev 0.050 → 0.080, maxNewDev 0.060 → 0.100.
// Very lenient T4 deviation thresholds.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        int t = originalTier();
        if (t == 4)
            return {16, 0.080, 0.100, 0.66, 0.0110, 2800, 280000, 1, 0.52, 2.30};
        if (t == 5)
