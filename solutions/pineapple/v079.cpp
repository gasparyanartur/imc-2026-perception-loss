// Pineapple v079: Enable weld and pair-disk post-passes for T5 (350k-1M).
// Currently `weldTierEnabled()` returns `originalTier() == 4` (45k-350k), so
// T5/T6 (giant tiers) skip weld and pair-disk entirely. We change the gate
// to also include T5. Hypothesis: giant meshes have many stranded edges after
// the main loop; weld/pair-disk can clean them up. Star-delete remains T4-only.
// Affects T5 (case 6) primarily; T2/T3/T4/T6 unchanged.
#include <bits/stdc++.h>
