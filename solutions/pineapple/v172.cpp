// Pineapple v172: v162 + T4 pair-disk scanVertices 90 → 1000 + maxSeconds 0.85 → 3.00.
// More aggressive T4 pair-disk.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams pairDiskParams() const
    {
        ...
        int t = originalTier();
        if (t == 4)
            return {8, 0.018, 0.029, 0.66, 0.0025, 1000, 120000, 1, 0.28, 3.00};
        if (t == 5)
