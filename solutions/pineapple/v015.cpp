// Pineapple v015: T5 keepRatio 0.025 -> 0.020 (case 6 direction).
// Tangerine confirmed T2-T4 have zero parameter slack. Try small reductions
// on T5 (50k-400k vertices, case 6 candidate). Hypothesis: T5 has more
// compression headroom than T2-T4 because the geometric-only face weight
// is more permissive.
#include <bits/stdc++.h>

static constexpr double HParam_Pineapple_KeepRatio_UpTo400k = 0.020;
