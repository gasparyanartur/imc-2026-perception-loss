// Pineapple v123: v117 + T5/T6 weld distFrac 0.80/0.95 → 0.65/0.80. Lower threshold.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {10, 0.020, 0.032, 0.65, 0.0150, 15000, 280000, 1, 0.60, 2.80};
        if (t == 6)
            return {6, 0.024, 0.038, 0.80, 0.0180, 15000, 280000, 1, 0.68, 5.00};
