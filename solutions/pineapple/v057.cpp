// Pineapple v057: IMMUTABLE BASELINE (identical to v055, 90.220962).
// Hypothesis: serve as the in-batch baseline control to isolate any
// drift between batches on Kattis scoring.
#include <bits/stdc++.h>
