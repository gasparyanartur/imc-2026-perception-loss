// Pineapple v011: Anchor strengthening for visible vertices (no positional).
// Hypothesis: Nebula's anchor quadric protects screen-pixel-weighted vertices,
// but the strength is tier-scaled. Boosting it 1.4x on T2 and 1.2x on T4
// (the failing tiers) should protect visible vertices without the
// over-penalization of positional silhouette planes.
#include <bits/stdc++.h>

static constexpr bool HParam_Pineapple_AnchorBoost = true;
...
private:
    ...
    void initFaceWeights()
    {
        ...
        if (screenTier == 2 || screenTier == 4)
        {
            ...
            double boost = HParam_Pineapple_AnchorBoost ? (screenTier == 2 ? HParam_Pineapple_AnchorBoostT2 : HParam_Pineapple_AnchorBoostT4) : 1.0;
            for (int i = 0; i < nV; ++i)
