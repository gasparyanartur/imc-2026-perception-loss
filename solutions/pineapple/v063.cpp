// Pineapple v063: IMMUTABLE BASELINE (identical to v055, 90.220962).
// Hypothesis: serves as in-batch baseline control for batch 8 to
// detect score drift across submission rounds.
#include <bits/stdc++.h>
