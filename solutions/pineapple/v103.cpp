// Pineapple v103: v100 + T5 weld maxSeconds 2.80 → 5.00. More time for T5 weld.
// Hypothesis: even with scanVertices bumped, maxSeconds is the time budget that
// might be limiting T5 weld.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {10, 0.020, 0.032, 0.80, 0.0150, 2500, 280000, 1, 0.60, 5.00};
        if (t == 6)
