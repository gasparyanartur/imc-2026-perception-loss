// Pineapple v084: Build on v079 (T5 weld/pair-disk enable) with T5 params
// doubled (maxValence 6→12, scanVertices 760→1500, hardCap stays). Hypothesis:
// v079's +0.018pt local improvement suggests T5 has many stranded edges; more
// aggressive weld/pair-disk finds more candidates. Affects T5 only.
#include <bits/stdc++.h>
