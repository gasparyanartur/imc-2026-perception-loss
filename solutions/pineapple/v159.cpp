// Pineapple v159: v155 + T4 pair-disk scanVertices 90 → 200 + maxSeconds 0.85 → 2.00.
// Aggressive T4 pair-disk.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        int t = originalTier();
        if (t == 4)
            return {12, 0.015, 0.024, 0.66, 0.0110, 2000, 280000, 1, 0.52, 2.30};
        if (t == 5)
