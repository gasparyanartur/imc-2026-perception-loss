// Pineapple v002: Vega-gated QEM acceptance on screen core (T2-T4).
// Hypothesis: Nebula accepts collapses based on quadric cost and silhouette
// energy alone. A local Vega SSIM gate before applying each collapse should
// preserve visible features and let us push keep-ratios safely lower.
#include <bits/stdc++.h>
...
static constexpr double HParam_Pineapple_VegaGateBudgetSeconds = 4.0;
