// Pomegranate v030: two-pass star retriangulation with 4x geometry envelope
...
void continueAbsoluteStar(int passes){screenTier=4;accepted=0;for(int i=0;i<passes&&elapsed()<HParam_TimeBudgetSeconds-1.35;++i)largeStarPass(inputV,5,4.0);compact();}
