// Pomegranate v001: conservative manifold-safe valence/quality edge-flip
...
static constexpr int HParam_PomegranateFlipProfile = 1;
...
double coplanar=0.997,align=0.995,qualityFloor=0.92;
...
if(gain<2)continue;double diagGain=norm(verts[a]-verts[b])/(norm(verts[c]-verts[d])+1e-15);
