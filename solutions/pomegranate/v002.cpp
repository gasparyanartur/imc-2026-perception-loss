// Pomegranate v002: broader collapse-opportunity edge-flip preconditioning.
...
static constexpr int HParam_PomegranateFlipProfile = 2;
...
if(HParam_PomegranateFlipProfile==2){scanCap*=2;acceptCap*=2;}
double coplanar=0.990,align=0.985,qualityFloor=0.85;
...
if(gain<2&&!(gain>=0&&newQ>1.10*oldQ&&diagGain>1.02))continue;
