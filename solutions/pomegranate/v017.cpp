// Pomegranate v017: strict 10-degree flat-normal continuation guard
...
bool strictCollapseGeometrySafe(const CollapseCandidate&c)const{
    ...
    for(int fi:patch){
        ...
        double normalFloor=screenTier==4?0.985:0.20;if(d<normalFloor)return false;
        double ar=nl/ol;if(ar<(screenTier==4?0.15:0.025)||ar>(screenTier==4?6.0:35.0))return false;
