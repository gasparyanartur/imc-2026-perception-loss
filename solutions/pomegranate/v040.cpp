// Pomegranate v040: 25-45k strict Vega-scored star continuation
...
if(inputV>400000)qemDeadline=17.0;
...
void continueAbsoluteQem(double ratio){
    ...
    if(inputV>25000&&inputV<=45000)vegaSsimStarPass();
    compact();
}
