// Durian v025: v019 (T5 0.024) + cost cap -10% (0.0375 -> 0.0338).
// v010 (cost cap +20%) hurt score. Try -10% (more conservative).
#include <bits/stdc++.h>
...
static constexpr double HParam_QemCostCapCoeff = 0.0338;
