// Durian v107: v105 + even tighter absoluteQemEndgame lower bounds (T2 0.13, T3/T4 0.065).
// Push medium-tier endgame ratios further after v105 showed local improvement.
#include <bits/stdc++.h>
