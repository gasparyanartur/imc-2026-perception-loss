// Durian v071: v065 + more aggressive tail batch for T7.
// Start earlier (11.0), scan more edges (262144), accept more (8192).
// World model: T6 (test 7) is runtime-sensitive. More tail-batch work may help.
#include <bits/stdc++.h>
...
static constexpr double HParam_KeepRatio_Huge = 0.026;
...
static constexpr double HParam_TailBatchStopElapsed = 19.9;

static constexpr int HParam_TailBatchScanEdges = 262144;

static constexpr int HParam_TailBatchTargetAccepts = 8192;
