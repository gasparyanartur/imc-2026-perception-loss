// Durian v134: v131 + CParam_HausdorffDiagFraction 0.07.
// Very aggressive Hausdorff bound for maximum compression.
#include <bits/stdc++.h>

using namespace std;

static constexpr double CParam_HausdorffDiagFraction = 0.07;
