// Durian v035: v019 + SSIM-aware collapse priority (less greedy QEM).
// World model says QEM is greedy and doesn't maintain collapsibility.
// Add a small per-face SSIM penalty to the priority, so screen-important
// vertices get less greedy collapses. Modest +20% bias on face weight.
// Hypothesis: maintains case 7 SSIM while still adding some T5 compression.
#include <bits/stdc++.h>
...
static constexpr double CParam_MaxFaceWeight = 3.6;
