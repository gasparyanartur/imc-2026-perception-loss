// Durian v012: v055 baseline + T5 keepRatio 0.025 -> 0.024 (tighter T5).
// Hypothesis: T5 (350k-1M tier) may have a small slack to compress.
// 0.024 = -4% retention. Should fit case 7.
#include <bits/stdc++.h>
