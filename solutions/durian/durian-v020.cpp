// Durian v020: v002 + T2 keepRatio_25k 0.32 -> 0.31 (slight T2 tightening).
// Tier 2 (test 3) is SSIM-sensitive per world model.
// Hypothesis: T2 has very small slack. 0.31 might be safe.
#include <bits/stdc++.h>
