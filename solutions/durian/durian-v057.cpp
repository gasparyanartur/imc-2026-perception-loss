// Durian v057: v063 base + T2 keepRatio 0.32 -> 0.30 (BINARY SEARCH per world model).
// World model: T2 is SSIM-sensitive but may have small slack.
// Try binary search: 0.4 -> P, 0.2 -> F, 0.3 -> P, 0.25 -> ?, etc.
// Start with 0.30 to probe looser compression.
#include <bits/stdc++.h>
