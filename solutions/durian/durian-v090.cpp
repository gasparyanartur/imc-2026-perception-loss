// Durian v090: v083 + vegaSsimEdgePass (local SSIM-aware edge collapses).
// Algorithmic change: after screen-core mid, do a pass that only collapses edges
// whose local 6-view SSIM stays >= 0.99992. Goal: make aggressive keepRatios safer.
#include <bits/stdc++.h>
