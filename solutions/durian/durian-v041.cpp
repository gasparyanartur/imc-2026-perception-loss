// Durian v041: v002 + qemDeadline for T6+ set to HParam_TimeBudgetSeconds - 0.5.
// Currently T6+ (inputV>400k) uses HParam_TimeBudgetSeconds (no early termination).
// Ending greedy QEM earlier (at 19.7s) leaves more time/budget for the SSIM post-pass.
// Hypothesis: less-greedy main loop + more time for Vega SSIM = better case 7 SSIM.
#include <bits/stdc++.h>
...
if(inputV>400000)qemDeadline=HParam_TimeBudgetSeconds-0.50;
