// Durian v072: v065 + enable absoluteQemEndgame for T3 with relaxed budget.
// v063 skips T3 endgame. Tranberry v064 tried relaxed budget + T3 but scored same.
// On v065 base (T5=0.024, T6=0.026), maybe T3 endgame adds compression.
#include <bits/stdc++.h>
...
void absoluteQemEndgame(){
    // Enable endgame for T2 and T3 (was T2 only in v063).
