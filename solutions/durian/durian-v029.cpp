// Durian v029: v002 + lower minSafe thresholds in absoluteQemEndgame.
// T2 minSafe 0.9200 -> 0.9100; T3 0.9180 -> 0.9100; T4 0.9250 -> 0.9200.
// Lower thresholds let endgame try tighter compression.
#include <bits/stdc++.h>
...
void absoluteQemEndgame(){
    ...
    double minSafe=inputV<=25000?0.9100:(inputV<=45000?0.9100:0.9200);
