// Durian v027: v002 + T5 0.024 + T2 endgame tries get tighter (0.20, 0.21, 0.22, 0.23, 0.24, 0.25).
// absoluteQemEndgame for T2 tries tighter ratios in order. Adding 0.20-0.23
// at FRONT tries them first. If SSIM holds, we get more compression.
#include <bits/stdc++.h>
...
void absoluteQemEndgame(){
    ...
    vector<double>tries;
    if(inputV<=25000)tries={0.205,0.215,0.225,0.245,0.255,0.265,0.275,0.285};
