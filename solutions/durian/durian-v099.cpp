// Durian v099: v097 + looser original-reference threshold (0.9990) and larger cap (400).
// Test whether the correct original-mesh reference allows more safe collapses.
#include <bits/stdc++.h>
