// Durian v055: v002 + HParam_RootNudgeProfile 1 -> 3 (root nudge for T2/T3/T4).
// STRUCTURAL change: root nudge preserves triangle-fan shape better.
// Profile 3 gives more aggressive root nudge on T2/T3 (case 3 and case 4).
// Hypothesis: better shape preservation = more compression without breaking SSIM.
#include <bits/stdc++.h>
...
static constexpr int HParam_RootNudgeProfile = 3;
