// Durian v050: v019 + T6 keepRatio 0.032 -> 0.040 (very loose).
// Confirms the range where case 7 passes. Score expected around v046 (90.10).
// Plus T5=0.024 compression boost vs v002 T5=0.025.
#include <bits/stdc++.h>
