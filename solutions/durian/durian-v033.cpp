// Durian v033: v002 + T2 keepRatio 0.32 -> 0.30 (tighter T2 only).
// Hypothesis: T2 tightening is SSIM-sensitive (per world model), but small changes
// may be safe. v020 (T2 0.31) gave 74.08. Try 0.30.
// HOPE: stays PPPPPPP if T2 SSIM holds (T2 endpoint safety).
#include <bits/stdc++.h>
...
static constexpr double HParam_KeepRatio_UpTo25k = 0.30;
