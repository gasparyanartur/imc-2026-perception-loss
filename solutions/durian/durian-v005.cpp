// Durian v005: v055 baseline + T6 weld enable with T4-equivalent scan (760).
// Hypothesis: case 7 timeout in v072 is from over-aggressive tail batch.
// Restore safe tail params (v055 baseline) but enable T6 weld at scan 760.
// This should add ~50 T6 weld deletes without timing out case 7.
// Also enable T5 weld scan 760 (same conservative setting).
#include <bits/stdc++.h>
