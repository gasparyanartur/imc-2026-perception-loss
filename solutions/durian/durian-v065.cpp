// Durian v065: v060 (T5=0.024) + T6 keepRatio 0.028 -> 0.026 (push tighter).
// v060 scored 90.299691. v062 scored 90.316844 at same settings.
// Hypothesis: combine v060 + T6=0.026 = even better.
#include <bits/stdc++.h>
