// Durian v008: v055 baseline + T6 keepRatio 0.028 -> 0.027 (tighter giant tier).
// Hypothesis: v055 = 0.028. Push to 0.027 for more compression.
// Risk: 0.028 sometimes fails case 7 in Pineapple data. 0.027 may always fail.
#include <bits/stdc++.h>

static constexpr double HParam_Pineapple_KeepRatio_UpTo400k = 0.025;
static constexpr double HParam_Pineapple_KeepRatio_Huge = 0.027;
