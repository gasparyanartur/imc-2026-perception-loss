// Durian v037: v019 + time budget 20.2 -> 21.0 (more time).
// Hypothesis (per world model): Tier 6 (test 7) is sensitive to run-time.
// More time allows the algorithm to finish case 7 in a stable state.
// +0.8s extra budget should give the algorithm more breathing room.
#include <bits/stdc++.h>
...
static constexpr double HParam_TimeBudgetSeconds = 21.0;
