// Durian v017: v055 + T5 keepRatio 0.025 -> 0.0243 + T6 keepRatio 0.028 -> 0.0278.
// v015 (T5 0.0245) scored 74.062595. Try slightly tighter on both tiers.
#include <bits/stdc++.h>

static constexpr double HParam_Pineapple_KeepRatio_UpTo400k = 0.0243;
static constexpr double HParam_Pineapple_KeepRatio_Huge = 0.0278;
