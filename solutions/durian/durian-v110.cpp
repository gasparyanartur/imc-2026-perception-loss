// Durian v110: v105 + absoluteQemEndgame T2 lower bound 0.145, T3/T4 0.068.
...
void absoluteQemEndgame(){
    ...
    double hi=double(safeV.size())/double(inputV),lo=inputV<=25000?0.145:0.068;bool improved=false;
