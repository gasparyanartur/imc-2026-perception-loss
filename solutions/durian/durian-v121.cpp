// Durian v121: v119 + absoluteQemEndgame T2 0.120, T3/T4 0.055, 7 iterations.
// Tighten the best bound and keep 7 search steps.
#include <bits/stdc++.h>
...
void absoluteQemEndgame(){
    ...
    double hi=double(safeV.size())/double(inputV),lo=inputV<=25000?0.120:0.055;bool improved=false;
