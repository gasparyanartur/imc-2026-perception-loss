// Durian v115: v113 + absoluteQemEndgame T2 lower bound 0.125, T3/T4 0.060.
// Aggressively push medium-tier ratios after v113's strong local result.
#include <bits/stdc++.h>
...
void absoluteQemEndgame(){
    ...
    for(int it=0;it<6&&elapsed()<HParam_TimeBudgetSeconds-1.25;++it){
