// Durian v010: v055 baseline + cost cap +20% (0.0375 -> 0.045).
// Hypothesis: Wider cost cap accepts more QEM collapses in main loop.
// Cost cap governs whether a proposed collapse is geometrically OK.
// +20% widens the gate, letting more collapses through.
#include <bits/stdc++.h>
...
static constexpr double HParam_QemCostCapCoeff = 0.045;
