// Durian v130: v119 + T6 keepRatio 0.0198 (slightly lower than 0.020).
// Test whether a small reduction in the giant tier is safe.
#include <bits/stdc++.h>
...
static constexpr double HParam_KeepRatio_Huge = 0.0198;
