// Durian v003: T5 weld enable, T6 weld still off. T4 weld baseline.
// Hypothesis: enabling T5 weld (similar to v079) gives +0.005pt at Kattis.
// T4 weld left unchanged from v072 baseline.
// T5 weld params: maxValence 10, scan 1500, dev 0.020/0.032.
// T6 weld stays disabled (known to be risky on hidden T6).
#include <bits/stdc++.h>
