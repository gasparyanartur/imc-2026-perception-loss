// Durian v004: T5 + T6 weld enable (full v079+v082 direction).
// T4 weld baseline; T5/T6 weld added with v079 safe params.
// T5: maxValence 10, scan 1500. T6: maxValence 8, scan 2500, maxSeconds 5.0.
// Hypothesis: stacking T5+T6 weld enable should compound the +0.005pt gain.
#include <bits/stdc++.h>
