// Durian v014: v055 baseline + T3 keepRatio 0.16 -> 0.155 (tighter T3).
// Hypothesis: T3 (35k-45k tier) screen-core may have small slack.
// T3 keepRatio is the safeTarget in screen-core, before finalTarget 0.145.
// Tighten safeTarget 0.16 -> 0.155 to get more compression.
// Risk: T3 is screen-core range, so any change affects case 4 (T3 hidden mesh).
#include <bits/stdc++.h>
