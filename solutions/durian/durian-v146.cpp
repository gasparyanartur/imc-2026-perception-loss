// Durian v146: v129 (T5=0.0238) + T5 keepRatio 0.0236.
// Fine-grained push of T5 between v129's 0.0238 and v145's 0.0235.
#include <bits/stdc++.h>
...
static constexpr double HParam_KeepRatio_UpTo400k = 0.0236;
