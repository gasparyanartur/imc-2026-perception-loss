// Durian v147: v083 + extend T7 ratio range downward to {.022,.024,.026,.028,.030,.031}.
// Try lower T7 ratios to find more compression. T7 is timing-sensitive but these
// ratios were tested in T6; here they get tested in T7.
#include <bits/stdc++.h>
