// Durian v026: v019 (T5 0.024) + MEMLESS for screen tiers only.
// v070 (MEMLESS=true for all tiers) broke case 4 in Pineapple.
// Try MEMLESS only on T2-T4.
#include <bits/stdc++.h>
...
MEMLESS = (nV > 5000 && nV <= 50000);  // screen tiers only, NOT T5+
