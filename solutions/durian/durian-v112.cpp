// Durian v112: v105 + relax absoluteQemEndgame time guard to 0.80s.
// Allow the binary search more time to find a lower safe ratio.
#include <bits/stdc++.h>
...
void absoluteQemEndgame(){
    ...
    for(int it=0;it<5&&elapsed()<HParam_TimeBudgetSeconds-0.80;++it){
