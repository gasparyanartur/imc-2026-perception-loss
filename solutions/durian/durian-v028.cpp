// Durian v028: v002 + T5 0.024 + T3 endgame tries get tighter.
// T3 tries change {0.112,0.120,0.127,0.134,0.140} -> {0.090,0.097,0.104,0.112,0.120,0.127,0.134,0.140}.
#include <bits/stdc++.h>
...
void absoluteQemEndgame(){
    ...
    else if(inputV<=45000)tries={0.090,0.097,0.104,0.112,0.120,0.127,0.134,0.140};
