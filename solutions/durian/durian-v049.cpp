// Durian v049: v019 + T6 keepRatio 0.032 -> 0.038 (looser).
// v019 (T5=0.024, T6=0.032) failed case 7 → 74.10. v048 (T5=0.025, T6=0.038) passed → 90.15.
// COMBINE: v019 + T6 looser to 0.038. Goal: keep T5=0.024 benefit AND get case 7 pass.
#include <bits/stdc++.h>
...
static constexpr double HParam_KeepRatio_Huge = 0.038;
