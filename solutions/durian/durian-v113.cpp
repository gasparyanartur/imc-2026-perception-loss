// Durian v113: v107 + 6 binary-search iterations in absoluteQemEndgame.
// Combine the tighter bounds with more search steps.
#include <bits/stdc++.h>
...
void absoluteQemEndgame(){
    ...
    double hi=double(safeV.size())/double(inputV),lo=inputV<=25000?0.13:0.065;bool improved=false;
