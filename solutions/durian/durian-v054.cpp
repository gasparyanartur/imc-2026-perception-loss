// Durian v054: v051 + T3 keepRatio 0.16 -> 0.15.
// Case 7 mesh is T6+, not affected by T3. Tighter T3 = more compression on cases 4.
// Risk: per world model, tier 3 (case 4) is SSIM-sensitive.
#include <bits/stdc++.h>
...
static constexpr double HParam_KeepRatio_UpTo45k = 0.15;
