// Durian v053: v051 + T2 keepRatio 0.32 -> 0.31 (tighter T2 only).
// Case 7 mesh is T6+, not affected by T2. If T2 tightening is SSIM-safe,
// we gain compression on cases 3 with no risk to case 7.
#include <bits/stdc++.h>
...
static constexpr double HParam_KeepRatio_UpTo25k = 0.31;
...
static constexpr double HParam_KeepRatio_Huge = 0.036;
