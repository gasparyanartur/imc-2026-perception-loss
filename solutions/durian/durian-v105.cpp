// Durian v105: v097 + push medium-tier endgame ratios lower in absoluteQemEndgame.
// Lower bounds: T2 0.14 (was 0.16), T3/T4 0.07 (was 0.075). 5 binary-search iterations.
#include <bits/stdc++.h>
