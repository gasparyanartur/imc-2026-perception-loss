// Durian v136: v131 + CParam_HausdorffDiagFraction 0.0675.
// Intermediate Hausdorff bound between 0.065 and 0.07.
#include <bits/stdc++.h>

using namespace std;

static constexpr double CParam_HausdorffDiagFraction = 0.0675;
