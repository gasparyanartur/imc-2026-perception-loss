// Durian v056: v002 + HParam_EnableVegaSsimPass = false.
// STRUCTURAL: SKIP the Vega SSIM post-pass entirely.
// Hypothesis (per world model): Vega is "not perfect" and creates trade-offs.
// Without it, pure QEM may produce different meshes that score better.
// Risk: lose the SSIM-aware safety net. 
#include <bits/stdc++.h>
...
static constexpr bool HParam_EnableVegaSsimPass = false;
