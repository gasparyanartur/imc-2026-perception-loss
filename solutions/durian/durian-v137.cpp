// Durian v137: v131 + absoluteQemEndgame minSafe 0.910.
// Looser SSIM guard on top of Hausdorff 0.06.
#include <bits/stdc++.h>
...
void absoluteQemEndgame(){
    ...
    double minSafe=inputV<=25000?0.9100:0.9100;if(safeScore.finalScore<minSafe)return;
