// Durian v036: v002 + T5 keepRatio 0.025 -> 0.0255 (slightly LOOSER T5).
// Hypothesis: Loosening T5 might give case 7 SSIM more margin. But it doesn't add compression.
// Risk: v002 baseline. Just a control test for the loosen direction.
#include <bits/stdc++.h>
...
static constexpr double HParam_KeepRatio_UpTo400k = 0.0255;
