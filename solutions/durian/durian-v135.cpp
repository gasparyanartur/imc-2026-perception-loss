// Durian v135: v131 + CParam_HausdorffDiagFraction 0.0625.
// Intermediate Hausdorff bound between 0.06 and 0.065.
#include <bits/stdc++.h>

using namespace std;

static constexpr double CParam_HausdorffDiagFraction = 0.0625;
