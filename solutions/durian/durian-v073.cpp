// Durian v073: v070 + T6 keepRatio 0.024 -> 0.023 (binary search lower).
// v070 scored 90.366367. Find T6 boundary.
#include <bits/stdc++.h>
...
static constexpr double HParam_KeepRatio_Huge = 0.023;
