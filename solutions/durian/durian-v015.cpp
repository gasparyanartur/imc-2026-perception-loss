// Durian v015: v055 baseline + T5 keepRatio 0.025 -> 0.0245 (very slight T5 tighten).
// Hypothesis: T5 may have very small slack. 0.0245 is tiny tightening.
// Risk: may break case 6 (T5 hidden) if T5 has zero slack.
#include <bits/stdc++.h>
