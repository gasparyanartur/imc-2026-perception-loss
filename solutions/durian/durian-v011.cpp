// Durian v011: v055 baseline + tail batch 1.5x (not 2x).
// Hypothesis: v055 tail batch (baseline) gives case 7 passes. v072's 2x tail
// batch breaks case 7. Try 1.5x as middle ground.
// scanEdges 65536 -> 98304, targetAccepts 2048 -> 3072, stop 19.4 -> 19.6.
#include <bits/stdc++.h>
...
static constexpr double HParam_TailBatchStopElapsed = 19.6;

static constexpr int HParam_TailBatchScanEdges = 98304;

static constexpr int HParam_TailBatchTargetAccepts = 3072;
