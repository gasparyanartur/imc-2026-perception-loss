// Durian v094: v090 + SSIM-aware tail batch.
// In runTailBatch, verify local SSIM >= 0.99992 before applying each selected collapse.
// Tail batch runs on T5/T6/T7 (threshold 2M). SSIM guard may make aggressive ratios safer.
#include <bits/stdc++.h>
