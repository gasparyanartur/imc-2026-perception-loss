// Durian v058: v063 base + T4 keepRatio 0.10 -> 0.09 (BINARY SEARCH per world model).
// World model: T4 has small slack (Pineapple tested this).
// Pineapple log showed T4 0.08 broke case 5. Find boundary.
#include <bits/stdc++.h>
