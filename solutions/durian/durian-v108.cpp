// Durian v108: v105 + lower runScreenCoreMid T2 targets {0.30,0.28,0.26}.
// Test whether starting the T2 screen-core at a leaner ratio improves final compression.
#include <bits/stdc++.h>
...
vector<double>st=screenTier==2?vector<double>{0.30,0.28,0.26}:vector<double>{0.14,0.10,0.08};
