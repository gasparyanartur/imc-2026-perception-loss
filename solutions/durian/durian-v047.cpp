// Durian v047: v002 + T6 keepRatio 0.032 -> 0.037 (slight loose).
// Hypothesis: 0.037 is between 0.034 (failed case 7) and 0.040 (passed case 7).
// Find the sweet spot - smallest loose that makes case 7 pass.
#include <bits/stdc++.h>
...
static constexpr double HParam_KeepRatio_Huge = 0.037;
