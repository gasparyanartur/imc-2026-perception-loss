// Durian v031: v019 + T6 keepRatio 0.032 -> 0.030 (slight T6 tightening on top).
// Best so far v019 at 74.10 (case 7 still fails). T6 keepRatio 0.032 was the
// case 7 safety margin. Push to 0.030 to see if case 7 still passes.
#include <bits/stdc++.h>
...
static constexpr double HParam_KeepRatio_Huge = 0.030;
