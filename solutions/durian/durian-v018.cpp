// Durian v018: v055 + T5 keepRatio 0.025 -> 0.0242 (even tighter than v015).
// v015 scored 74.062595 with T5 0.0245. Try 0.0242 to find breaking point.
#include <bits/stdc++.h>

static constexpr double HParam_Pineapple_KeepRatio_UpTo400k = 0.0242;
