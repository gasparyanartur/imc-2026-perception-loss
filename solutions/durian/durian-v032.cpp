// Durian v032: v019 + T5 keepRatio 0.024 -> 0.0245 (less aggressive).
// v019 (T5 0.024) gives 74.10 (case 7 fail). What if T5 0.0245 keeps case 7 valid?
// We saw v015 (v055 + T5 0.0245) case 7 failed too. But that was on v055 base.
// On v002 base, T5 0.0245 might be different.
#include <bits/stdc++.h>
...
static constexpr double HParam_KeepRatio_UpTo400k = 0.0245;
