// Durian v095: v094 + vegaSsimEdgePass compares each collapse against the original input mesh.
// Save sourceVerts/sourceFaces before screen-core for medium tiers; in localVegaSsimForEdge
// render the same screen patch from the original mesh and compare the after-collapse patch.
// Threshold loosened slightly to 0.9995 since the reference is now absolute.
#include <bits/stdc++.h>
...
if(!c.valid()||c.cost>costCap||localVegaSsimForEdge(c)<0.99950)continue;
if(independent){
