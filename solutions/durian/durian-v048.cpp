// Durian v048: v002 + T6 keepRatio 0.032 -> 0.038 (slight loose).
// Hypothesis: 0.038 is between 0.037 (tighter) and 0.040 (working at 90.10).
// Find the sweet spot for case 7 pass.
#include <bits/stdc++.h>
