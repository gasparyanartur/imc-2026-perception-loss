// Durian v069: v065 + T6 keepRatio 0.026 -> 0.025 (binary search lower).
// v065 scored 90.333021. T6=0.026 safe. Find lower boundary.
#include <bits/stdc++.h>
...
static constexpr double HParam_KeepRatio_Huge = 0.025;
