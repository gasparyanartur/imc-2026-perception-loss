// Durian v103: v101 but restrict raster-importance weights to T5 only (50k–400k).
// Do not build/modify T7 main QEM path. Test whether view-dependent weights help T5
// without breaking the timing-sensitive giant tier.
#include <bits/stdc++.h>
