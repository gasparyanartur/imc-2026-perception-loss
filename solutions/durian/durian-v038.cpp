// Durian v038: v019 + time budget 20.2 -> 19.6 (LESS time, less risk of timeout).
// v037 was +0.8s, try -0.6s. If algorithm finishes faster, case 7 mesh
// might be in a "valid" state before timing affects SSIM.
#include <bits/stdc++.h>
...
static constexpr double HParam_TimeBudgetSeconds = 19.6;
