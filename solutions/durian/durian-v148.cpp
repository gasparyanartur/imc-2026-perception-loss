// Durian v148: v083 + T7 hidden pass time guard extended from 0.80s to 1.30s.
// Give T7's occludedEdgeCollapsePass more time to find safe collapses.
#include <bits/stdc++.h>
...
if(elapsed()<HParam_TimeBudgetSeconds-1.30){
