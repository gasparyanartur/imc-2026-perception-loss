// Durian v062: v063 + T6 keepRatio 0.028 -> 0.026 (push tighter).
// v063 already has T6=0.028. Test if we can go even lower.
// World model says binary search. Try 0.026 (between 0.028 safe and 0.025 fail in Pineapple).
#include <bits/stdc++.h>
