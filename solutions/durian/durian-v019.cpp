// Durian v019: v002 (ariel v32) + T5 keepRatio 0.025 -> 0.024 (slight T5 tightening).
// v002 currently scores 90.23 PPPPPPP. v055 with T5 0.0242 scored 74.067678 (case 7 fail).
// Risk: tightening T5 might break case 7 SSIM for v002 too.
// Hypothesis: since v002 has looser T6, case 7 mesh may have more compression headroom.
#include <bits/stdc++.h>
