// Durian v007: v055 baseline + T4 weld loosened (maxValence 10, dev 0.030/0.045).
// Hypothesis: v055 (90.22) wins on T6 keepRatio 0.028 alone. Adding T4 weld
// loosening should add compression without breaking case 7 (no T5/T6 changes).
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (originalTier() == 4)
            return {10, 0.030, 0.045, 0.66, 0.0110, 1500, 280000, 1, 0.52, 2.30};
