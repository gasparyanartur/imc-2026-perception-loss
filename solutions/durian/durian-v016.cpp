// Durian v016: v055 baseline + time budget 20.2 -> 21.0 (more time).
// Hypothesis: More time allows the main loop to do more collapses safely.
// Risk: Kattis might time out the program itself (>21s?).
// Safe increase: 0.8s extra total runtime.
#include <bits/stdc++.h>
