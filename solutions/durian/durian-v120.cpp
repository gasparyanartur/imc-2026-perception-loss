// Durian v120: v115 + relax absoluteQemEndgame time guard to 0.50s.
// Allow the binary search to continue closer to the deadline.
#include <bits/stdc++.h>
...
void absoluteQemEndgame(){
    ...
    for(int it=0;it<6&&elapsed()<HParam_TimeBudgetSeconds-0.50;++it){
