// Durian v039: v002 + T6 runLargeCameraTx tries tighter (0.022, 0.024, 0.026, 0.028).
// Currently tries 0.026/0.028/0.030/0.031. Adding tighter options at the start.
// If any passes largeDeltaGuard, we get more case 7 compression.
#include <bits/stdc++.h>
...
vector<double>tries={.022,.024,.026,.028,.030,.031};
bool qemKept=false;
for(double ratio:tries){
