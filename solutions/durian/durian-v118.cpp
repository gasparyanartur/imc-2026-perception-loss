// Durian v118: v115 + absoluteQemEndgame T2 lower bound 0.110, T3/T4 0.045.
// Very aggressive medium-tier ratio exploration.
#include <bits/stdc++.h>
...
void absoluteQemEndgame(){
    ...
    double hi=double(safeV.size())/double(inputV),lo=inputV<=25000?0.110:0.045;bool improved=false;
