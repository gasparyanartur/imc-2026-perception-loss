// Durian v009: v055 baseline + T5 weld enable at moderate scan (1500).
// Hypothesis: v055 (90.22) wins on T6 keepRatio 0.028. Adding T5 weld
// at moderate scan (1500) may add a few percent compression.
// T6 weld stays disabled to avoid timeout.
#include <bits/stdc++.h>
...
private:
    ...
    StarParams weldParams() const
    {
        ...
        if (t == 5)
            return {8, 0.020, 0.032, 0.75, 0.0130, 1500, 280000, 1, 0.55, 1.80};
