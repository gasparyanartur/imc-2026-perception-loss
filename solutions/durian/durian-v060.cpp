// Durian v060: v063 base + T5 keepRatio 0.025 -> 0.024 (binary search).
// World model says binary search to find boundary.
// T5=0.025 in v063. Tighter 0.024 might still pass.
#include <bits/stdc++.h>
