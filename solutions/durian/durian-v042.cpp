// Durian v042: v002 + T6 runLargeCameraTx tries: 0.020, 0.022, 0.024, 0.026, 0.028.
// Even tighter than v039 (which had 0.022, 0.024). Going aggressively tight.
// If the Vega guard accepts, we get massive case 7 compression.
#include <bits/stdc++.h>
...
vector<double>tries={.020,.022,.024,.026,.028};
bool qemKept=false;
for(double ratio:tries){
