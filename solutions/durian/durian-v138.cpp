// Durian v138: v131 + absoluteQemEndgame minSafe 0.930.
// Stricter SSIM guard on top of Hausdorff 0.06.
#include <bits/stdc++.h>

using namespace std;

static constexpr double CParam_HausdorffDiagFraction = 0.06;
...
void absoluteQemEndgame(){
    ...
    double minSafe=inputV<=25000?0.9300:0.9300;if(safeScore.finalScore<minSafe)return;
