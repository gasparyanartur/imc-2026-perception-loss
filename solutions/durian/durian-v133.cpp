// Durian v133: v131 + CParam_HausdorffDiagFraction 0.065.
// Push the Hausdorff bound higher for more compression.
#include <bits/stdc++.h>

using namespace std;

static constexpr double CParam_HausdorffDiagFraction = 0.065;
