// Durian v122: v119 + absoluteQemEndgame T2 0.115, T3/T4 0.050, 7 iterations.
// Tighten the best bound further with 7 search steps.
#include <bits/stdc++.h>
...
void absoluteQemEndgame(){
    ...
    double hi=double(safeV.size())/double(inputV),lo=inputV<=25000?0.115:0.050;bool improved=false;
