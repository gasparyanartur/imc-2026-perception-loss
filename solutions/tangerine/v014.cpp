// Tangerine v014: all finishers plus an all-tier local normal-cone guard.
#include <bits/stdc++.h>
...
private:
    ...
    void runScreenCoreMid()
    {
        ...
        if (screenTier == 3)
        {
            int finalTarget = (int)floor(nV * 0.137), safeTarget = (int)floor(nV * 0.155);
        ...
        vector<double> st = screenTier == 2 ? vector<double>{0.340, 0.310, 0.284} : vector<double>{0.120, 0.086, 0.072};
        for (double kr : st)
        {
