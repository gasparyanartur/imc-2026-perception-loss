// Tangerine v019: quality-first directional saliency, strict local geometry, profile 4/5.
#include <bits/stdc++.h>

using namespace std;

static constexpr int HParam_TangerineProfile = 4;
...
private:
    ...
    double tangerineRankWeight() const
    {
        static constexpr double x[5][6] = {
            ...
            {0.048, 0.056, 0.064, 0.0015, 0.048, 0.040},
            {0.096, 0.112, 0.128, 0.144, 0.096, 0.080}};
        return x[tangerineProfileIndex()][tangerineTierBin()];
    }
