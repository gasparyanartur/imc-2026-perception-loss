// Tangerine v010: simultaneous half-step reductions on all three mid tiers.
#include <bits/stdc++.h>
...
private:
    ...
    void runScreenCoreMid()
    {
        ...
        if (screenTier == 3)
        {
            int finalTarget = (int)floor(nV * 0.1425), safeTarget = (int)floor(nV * 0.158);
        ...
        vector<double> st = screenTier == 2 ? vector<double>{0.355, 0.325, 0.295} : vector<double>{0.135, 0.098, 0.079};
        for (double kr : st)
        {
