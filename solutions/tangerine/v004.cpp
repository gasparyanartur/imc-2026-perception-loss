// Tangerine v004: near-95 staged screen-space target profile.
#include <bits/stdc++.h>
...
private:
    ...
    void runScreenCoreMid()
    {
        ...
        if (screenTier == 3)
        {
            int finalTarget = (int)floor(nV * 0.08), safeTarget = (int)floor(nV * 0.12);
        ...
        vector<double> st = screenTier == 2 ? vector<double>{0.22, 0.18, 0.14} : vector<double>{0.075, 0.060, 0.045};
        for (double kr : st)
        {
