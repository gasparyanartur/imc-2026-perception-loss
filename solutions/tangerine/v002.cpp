// Tangerine v002: moderate staged screen-space target reduction.
#include <bits/stdc++.h>
...
private:
    ...
    void runScreenCoreMid()
    {
        ...
        if (screenTier == 3)
        {
            int finalTarget = (int)floor(nV * 0.12), safeTarget = (int)floor(nV * 0.15);
        ...
        vector<double> st = screenTier == 2 ? vector<double>{0.32, 0.28, 0.24} : vector<double>{0.11, 0.09, 0.07};
        for (double kr : st)
        {
