...
/*
IMC2026 Problem B — simplifygeometry_v33_tier_sweep_b.cpp

V25 common-neighbor tail batching plus aggressive mid-tier keep-ratio sweep.
...
static constexpr double HParam_KeepRatio_UpTo25k   = 0.27;
static constexpr double HParam_KeepRatio_UpTo45k   = 0.155;
static constexpr double HParam_KeepRatio_UpTo50k   = 0.085;
static constexpr double HParam_KeepRatio_UpTo400k  = 0.035;
