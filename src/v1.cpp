...
static constexpr double hparam_FirstQemBudgetSeconds = 16.6;

// ---- Phase 2 (general star-delete) time budget (seconds) ----
static constexpr double hparam_GeneralStarPostBudgetSeconds = 17.6;
...
static constexpr double COPLANAR_EPS_NORMAL = 1e-5;   // 1 - |n1·n2|
static constexpr double COPLANAR_EPS_OFFSET = 1e-5;   // |d1 - d2|
