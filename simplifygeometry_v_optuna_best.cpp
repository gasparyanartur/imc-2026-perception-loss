...
objective=14261.000000
torus_1m_vertices=14261 torus_1m_time=19.110
torus_400k_vertices=18000 torus_400k_time=7.390
params=TrialParams(time_budget=18.3, cost_cap=0.014, batch_start=11.6, batch_stop=18.3, scan_edges=32768, batch_target=1024, conflict_mode=2, jitter_amplitude=0.02, jitter_seed=25)
*/
#include <bits/stdc++.h>
using namespace std;
...
static constexpr double HParam_TimeBudgetSeconds = 18.300000;
...
static constexpr double HParam_QemCostCapCoeff = 0.014000;
...
static constexpr double HParam_TailBatchElapsedStart = 11.600000;
static constexpr double HParam_TailBatchStopElapsed = 18.300000;
static constexpr int    HParam_TailBatchScanEdges = 32768;
static constexpr int    HParam_TailBatchTargetAccepts = 1024;
static constexpr int    HParam_TailBatchConflictMode = 2; // 0=one-ring, 1=common-neighbor, 2=endpoints
static constexpr double HParam_TailBatchJitterAmplitude = 0.020000;
static constexpr unsigned long long HParam_TailBatchJitterSeed = 25ULL;
