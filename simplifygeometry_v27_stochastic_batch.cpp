...
/*
IMC2026 Problem B — simplifygeometry_v27_stochastic_batch.cpp

V24 tail batching with deterministic stochastic candidate ordering.
...
static constexpr int    HParam_TailBatchConflictMode = 0; // 0=one-ring, 1=common-neighbor, 2=endpoints
static constexpr double HParam_TailBatchJitterAmplitude = 0.005;
static constexpr unsigned long long HParam_TailBatchJitterSeed = 1ULL;
