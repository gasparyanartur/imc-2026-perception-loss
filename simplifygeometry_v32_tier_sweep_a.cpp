...
/*
IMC2026 Problem B — simplifygeometry_v32_tier_sweep_a.cpp

V25 common-neighbor tail batching plus moderate mid-tier keep-ratio sweep.
...
static constexpr double HParam_KeepRatio_UpTo45k   = 0.17;
static constexpr double HParam_KeepRatio_UpTo50k   = 0.095;
static constexpr double HParam_KeepRatio_UpTo400k  = 0.040;
